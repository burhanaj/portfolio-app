...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0c1c35] flex justify-center items-center p-4' id='contact'>
        <form method='POST' action="https://getform.io/f/eb7178cc-4a4f-455e-bdda-604bfce64b61" className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='my-4 p-2 bg-[#ccd6f6]' type="tel" placeholder='Phone Number' name='phoneNumber' />
